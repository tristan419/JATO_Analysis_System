...
APP_GROUPED_TIME_SERIES_PREWARM_GRAINS="${APP_GROUPED_TIME_SERIES_PREWARM_GRAINS:-month}"
APP_GROUPED_TIME_SERIES_PREWARM_SCOPES="${APP_GROUPED_TIME_SERIES_PREWARM_SCOPES:-viewer,admin}"
