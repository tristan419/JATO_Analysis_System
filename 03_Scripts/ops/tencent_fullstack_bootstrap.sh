...
DEFAULT_GROUPED_TIME_SERIES_PREWARM_FILTERS_JSON='[{"国家":["丹麦","克罗地亚","匈牙利","奥地利","希腊","德国","意大利","挪威","捷克","斯洛伐克","斯洛文尼亚","比利时","法国","波兰","瑞典","瑞士","罗马尼亚","芬兰","荷兰","葡萄牙","西班牙"],"动总规整":["ICE","HEV","BEV","MHEV","PHEV"]}]'
APP_GROUPED_TIME_SERIES_PERSISTENT_CACHE_ENABLED="${APP_GROUPED_TIME_SERIES_PERSISTENT_CACHE_ENABLED:-true}"
APP_GROUPED_TIME_SERIES_PREWARM_ENABLED="${APP_GROUPED_TIME_SERIES_PREWARM_ENABLED:-true}"
APP_GROUPED_TIME_SERIES_PREWARM_GROUP_BY="${APP_GROUPED_TIME_SERIES_PREWARM_GROUP_BY:-动总规整,国家}"
APP_GROUPED_TIME_SERIES_PREWARM_GRAINS="${APP_GROUPED_TIME_SERIES_PREWARM_GRAINS:-month,year}"
APP_GROUPED_TIME_SERIES_PREWARM_SCOPES="${APP_GROUPED_TIME_SERIES_PREWARM_SCOPES:-viewer,order_filler,editor,admin}"
APP_GROUPED_TIME_SERIES_PREWARM_FILTERS_JSON="${APP_GROUPED_TIME_SERIES_PREWARM_FILTERS_JSON:-$DEFAULT_GROUPED_TIME_SERIES_PREWARM_FILTERS_JSON}"
...
APP_GROUPED_TIME_SERIES_PERSISTENT_CACHE_ENABLED=$APP_GROUPED_TIME_SERIES_PERSISTENT_CACHE_ENABLED
APP_GROUPED_TIME_SERIES_PREWARM_ENABLED=$APP_GROUPED_TIME_SERIES_PREWARM_ENABLED
APP_GROUPED_TIME_SERIES_PREWARM_GROUP_BY=$APP_GROUPED_TIME_SERIES_PREWARM_GROUP_BY
APP_GROUPED_TIME_SERIES_PREWARM_GRAINS=$APP_GROUPED_TIME_SERIES_PREWARM_GRAINS
APP_GROUPED_TIME_SERIES_PREWARM_SCOPES=$APP_GROUPED_TIME_SERIES_PREWARM_SCOPES
APP_GROUPED_TIME_SERIES_PREWARM_FILTERS_JSON='$APP_GROUPED_TIME_SERIES_PREWARM_FILTERS_JSON'
EOF
