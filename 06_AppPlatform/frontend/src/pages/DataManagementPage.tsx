                  ...
                  <div className="card crud-card">
                    ...
                    <div style={{padding:12}}>
                      {hermesMsrpProgress ? (() => {
                        ...
                        const pipelineIssueCount = progress.sourceRepairBacklog?.pipelineIssueCount ?? 0;
                          ...
                          <div style={{display:"grid",gap:10}}>
                            <div style={{display:"grid",gridTemplateColumns:"repeat(4,minmax(0,1fr))",gap:6}}>
                              ...
                              <div style={{padding:"8px 10px",background:"#fff",border:"1px solid #e2e8f0",borderRadius:6}}>
                                ...
                                <div style={{fontSize:10,color:"#64748b",whiteSpace:"nowrap"}}>{pipelineIssueCount} pipeline · {externalAccessIssueCount} external · {recheckCount} recheck · {issueCount} total</div>
                              </div>
                            </div>
                            ...
                            <div style={{background:"#fff",border:"1px solid #e2e8f0",borderRadius:6,padding:8}}>
                              ...
                              {backlogGroups.length ? (
                                <div style={{fontSize:10,color:"#64748b",display:"grid",gridTemplateColumns:"minmax(0,1.1fr) 54px 42px 48px 48px 48px minmax(0,1.1fr)",gap:8,marginBottom:4}}>
                                  <span>Reason</span>
                              ...
                              {backlogGroups.length ? backlogGroups.slice(0,5).map((group: HermesMsrpSourceRepairBacklogGroup) => (
                                <div key={group.failureReason} style={{fontSize:11,display:"grid",gridTemplateColumns:"minmax(0,1.1fr) 54px 42px 48px 48px 48px minmax(0,1.1fr)",gap:8,alignItems:"center",marginBottom:5}}>
                                  ...
                                  <strong
                                    style={{textAlign:"right",color:group.priorityBand === "pipeline" ? "#9333ea" : group.priorityBand === "external_access" ? "#7c3aed" : group.priorityBand === "recheck" ? "#2563eb" : "#475569"}}
                                  ...
                                  <strong style={{textAlign:"right",color:(group.pipelineIssueCount ?? 0) > 0 ? "#9333ea" : "#94a3b8"}}>{group.pipelineIssueCount ?? 0}</strong>
