...
## 10. JATO Dashboard 落地备注（2026-04-09）

- Hero 不再保留解释性大段文案与 `Current scope` 大面板，改成更克制的 KPI + active lens rail。
- `01 / Market Overview` 折叠态保持单行语义，桌面高度控制在约 `56px`，右上/右下只保留 `28px` 微型 toggle。
