...
### 2026-09-25 最终确认方案与 Luna Max 任务（最高优先级；代码已修订，待组合审阅）

本节替代旧 C5–C8、旧 #236 方案中冲突的定价要求；历史测试和部署记录不代表此方案已实现。保留 A/B/C/D 已合并成果，不重做整页、认证或共享色库，不增加新门禁/定价框架。#236 代码修订已完成，尚未合并，必须先审阅组合结果。
