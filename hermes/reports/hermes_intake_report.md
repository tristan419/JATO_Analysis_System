...
- **Generated at:** 2026-05-14T12:11:11Z
- **Sections detected:** 11
- **Keywords detected:** backend(2), data(1), feature(1), frontend(3), pipeline(1)
- **Routes mentioned:** `/Share/Rank/Price`, `/share/rank/msrp`, `/Empty/Error`, `/Rank`, `/YTD`, `/segment/fuel/msrp/length`, `/rank/share`, `/api/ranking-trend`
...
- [ ] Pipeline Registry: review 6 matched pipelines
