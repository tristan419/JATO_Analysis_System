...
- **Generated at:** 2026-05-14T15:04:56Z
- **Sections detected:** 44
- **Keywords detected:** backend(7), cost(1), data(1), feature(2), frontend(5), llm(1), pipeline(2), test(1)
- **Routes mentioned:** `/app/main`, `/v1/engineering/projects/`, `/v1/presence`, `/app/services/presence_service`, `/src/App`, `/src/pages/EngineeringPage`, `/src/hooks/usePresence`, `/v1/presence/heartbeat`
- **API paths mentioned:** `/v1/presence/heartbeat`, `/v1/presence/online`, `/v1/engineering/variants/`, `/v1/ws`, `/v1/engineering/projects/`, `/v1/presence`
...
Affected files: 06_AppPlatform/backend/app/services/presence_service.py, 06_AppPlatform/backend/app/api/routes/presence.py, 06_AppPlatform/frontend/src/hooks/useWebSocket.ts, 06_AppPlatform/frontend/src/hooks/usePresence.ts, 06_AppPlatform/backend/app/services/ws_service.py
